...
call sp_agregarUsuario("Admin Sistema", "admin@sigal.gt", "$2b$10$hashAdmin123", "ADMIN");
call sp_agregarUsuario("Carlos Mendoza", "carlos@sigal.gt", "$2b$10$hashEst001", "ESTUDIANTE");
call sp_agregarUsuario("Andrea López", "andrea@sigal.gt", "$2b$10$hashEst002", "ESTUDIANTE");
call sp_agregarUsuario("María García", "maria@sigal.gt", "$2b$10$hashEst003", "ESTUDIANTE");
call sp_agregarUsuario("José Hernández", "jose@sigal.gt", "$2b$10$hashEst004", "ESTUDIANTE");
call sp_agregarUsuario("Luisa Ramírez", "luisa@sigal.gt", "$2b$10$hashEst005", "ESTUDIANTE");
call sp_agregarUsuario("Dr. Roberto Fuentes", "rfuentes@sigal.gt", "$2b$10$hashProf001", "PROFESOR");
call sp_agregarUsuario("Lic. Ana Castillo", "acastillo@sigal.gt", "$2b$10$hashProf002", "PROFESOR");
call sp_agregarUsuario("Tech Solutions S.A.", "rrhh@techsolutions.gt", "$2b$10$hashEmp001", "EMPLEADOR");
call sp_agregarUsuario("Banco Progreso", "rrhh@bancoprogreso.gt", "$2b$10$hashEmp002", "EMPLEADOR");

-- Universidades (3 universidades con todos sus campos NOT NULL)
call sp_agregarUniversidad( "Universidad de San Carlos de Guatemala", "USAC", "Ciudad Universitaria, Zona 12", "Guatemala", "Guatemala", "2418-8000", "info@usac.edu.gt", "https://www.usac.edu.gt",
							"Dr. Walter Mazariegos", "USAC-001", "logo_usac.png", "Acreditada CSUCA", "PRESENCIAL,VIRTUAL");
                            
call sp_agregarUniversidad("Universidad Rafael Landívar", "URL", "Vista Hermosa III, Zona 16", "Guatemala", "Guatemala", "2426-2626", "info@url.edu.gt", "https://www.url.edu.gt",
							"Dr. Eduardo Valdés", "URL-001", "logo_url.png", "Acreditada ACAAI", "PRESENCIAL,HIBRIDO");
                            
call sp_agregarUniversidad("Universidad Mariano Gálvez", "UMG", "3a Avenida 9-00, Zona 2", "Guatemala", "Guatemala", "2411-8000", "info@umg.edu.gt", "https://www.umg.edu.gt",
							"Dr. Luis Ruano", "UMG-001", "logo_umg.png", "Acreditada ACAP", "PRESENCIAL,VIRTUAL,HIBRIDO");

-- Profesores (vinculados a usuarios 7 y 8)
call sp_agregarProfesor(7, 1, "PROF-001", "Ingeniería en Sistemas", "Bases de Datos", "Edificio T-3, Oficina 205", "2418-8100", "Lunes y Miércoles 10:00-12:00");
call sp_agregarProfesor(8, 2, "PROF-002", "Ciencias de la Computación", "Programación Web", "Edificio T-3, Oficina 210", "2418-8101", "Martes y Jueves 14:00-16:00");

-- Estudiantes (vinculados a usuarios 2-6, sin tutor asignado aún → null)
call sp_agregarEstudiante(2, 1, "EST-2025-001", "Ingeniería en Sistemas", 4, "COD-001");
call sp_agregarEstudiante(3, 1, "EST-2025-002", "Administración de Empresas", 3, "COD-002");
call sp_agregarEstudiante(4, 2, "EST-2025-003", "Ingeniería en Sistemas", 5, "COD-003");
call sp_agregarEstudiante(5, 2, "EST-2025-004", "Psicología", 2, "COD-004");
call sp_agregarEstudiante(6, 3, "EST-2025-005", "Derecho", 6, "COD-005");
...
call sp_agregarEmpleador(9,  "Tech Solutions S.A.", "NIT-123456-7", "Tecnología", "Zona 10, Guatemala", "2360-1000", "https://techsolutions.gt", 150, "Pedro Solano");
call sp_agregarEmpleador(10, "Banco Progreso", "NIT-987654-3", "Financiero", "Zona 9, Guatemala", "2338-5000", "https://bancoprogreso.gt", 800, "Rosa Velarde");

-- Cursos
call sp_agregarCurso("CC-101", "Programación I", "Fundamentos de programación estructurada en C++", 3, 3, 1, 1, "PRESENCIAL", "2025-1");
call sp_agregarCurso("CC-202", "Base de Datos I", "Diseño y administración de bases de datos relacionales", 3, 3, 1, 1, "PRESENCIAL", "2025-1");
call sp_agregarCurso("CC-303", "Desarrollo Web", "Tecnologías frontend y backend para desarrollo web moderno", 3, 3, 2, 1, "VIRTUAL", "2025-1");
call sp_agregarCurso("AD-101", "Contabilidad General","Principios básicos de contabilidad empresarial", 3, 3, 2, 1, "PRESENCIAL", "2025-1");

-- Horarios Académicos
call sp_agregarHorarioAcademico(1, 1, "LUNES", "07:00:00", "09:00:00", "S-101", "2025-1", 2025);
call sp_agregarHorarioAcademico(1, 2, "MIERCOLES", "07:00:00", "09:00:00", "S-202", "2025-1", 2025);
call sp_agregarHorarioAcademico(2, 3, "MARTES", "14:00:00", "16:00:00", "LAB-1", "2025-1", 2025);
call sp_agregarHorarioAcademico(3, 1, "JUEVES", "09:00:00", "11:00:00", "S-301", "2025-1", 2025);
call sp_agregarHorarioAcademico(4, 4, "VIERNES", "10:00:00", "12:00:00", "S-105", "2025-1", 2025);
call sp_agregarHorarioAcademico(5, 2, "LUNES", "13:00:00", "15:00:00", "S-202", "2025-1", 2025);

-- Horarios Laborales
call sp_agregarHorarioLaboral(1, 1, "Desarrollador Junior", "IT", "Ing. Marco Díaz", "LUNES", "14:00:00", "18:00:00", 3500.00);
call sp_agregarHorarioLaboral(1, 1, "Desarrollador Junior", "IT", "Ing. Marco Díaz", "MIERCOLES", "14:00:00", "18:00:00", 3500.00);
call sp_agregarHorarioLaboral(2, 2, "Cajero", "Cajas", "Lic. Sandra Rivas", "MARTES", "07:00:00", "15:00:00", 2800.00);
call sp_agregarHorarioLaboral(2, 2, "Cajero", "Cajas", "Lic. Sandra Rivas", "JUEVES", "07:00:00", "15:00:00", 2800.00);
call sp_agregarHorarioLaboral(3, 1, "Analista de Datos", "IT", "Ing. Marco Díaz", "LUNES", "13:00:00", "17:00:00", 4000.00);

-- Conflictos Horarios
-- Superposición: estudiante 2, martes clase 14:00-16:00 vs trabajo 07:00-15:00
call sp_registrarConflicto(2, 3, 3, "SUPERPOSICION",
	"El horario laboral del martes (07:00-15:00) se superpone con la clase de Desarrollo Web (14:00-16:00). Se recomienda solicitar cambio de turno laboral.");

-- Carga excesiva: estudiante 1 (no apunta a horario específico, por eso null en los ids)
call sp_registrarConflicto(1, null, null, "CARGA_EXCESIVA", "El estudiante supera 50 horas semanales entre clases y trabajo. Se recomienda reducir carga académica o laboral.");

-- Oportunidades
call sp_agregarOportunidad( "Pasantía en Desarrollo de Software", "Pasantía de 3 meses en el área de TI trabajando con tecnologías modernas como Node.js y Angular.", 
							"PASANTIA", 1, 1, "EMPLEADOR", "Estudiante de Ingeniería en Sistemas, mínimo 4to semestre, conocimientos en programación web.", 1500.00, "3 meses", "2025-08-31 23:59:59");
...
call sp_agregarOportunidad("Beca de Excelencia Académica 2025", "Beca completa para estudiantes con alto rendimiento académico que cubra colegiatura del segundo semestre.", "BECA", 1, 1, "UNIVERSIDAD",
							"Promedio mayor a 80 puntos, sin materias reprobadas, estudiante activo de la USAC.", 0.00, "1 semestre", "2025-07-15 23:59:59");
                            
call sp_agregarOportunidad("Empleo Part-Time Atención al Cliente", "Puesto de medio tiempo en sucursal bancaria, horario flexible adaptado a estudiantes universitarios.", "EMPLEO", 2, 1, "EMPLEADOR",
							"Estudiante universitario activo, buena presentación, disponibilidad fines de semana.", 2500.00, "Indefinido", "2025-09-30 23:59:59");

-- Evaluaciones
call sp_agregarEvaluacion(1, 1, "EXAMEN_PARCIAL", "Primer Parcial", "Evaluación de los primeros 4 temas del curso: variables, ciclos, funciones y arreglos.", 100, 25.00, "2025-03-15 08:00:00", "2025-03-15 10:00:00");
    
call sp_agregarEvaluacion(1, 1, "PROYECTO", "Proyecto Final", "Desarrollo de una aplicación de consola que resuelva un problema real usando POO.", 100, 40.00, "2025-05-20 08:00:00", "2025-05-20 23:59:59");
    
call sp_agregarEvaluacion(2, 1, "EXAMEN_PARCIAL", "Primer Parcial BD", "Evaluación de modelo entidad-relación, normalización y consultas SQL básicas.", 100, 30.00, "2025-03-18 08:00:00", "2025-03-18 10:00:00");
    
call sp_agregarEvaluacion(3, 2, "TAREA", "Maquetado HTML y CSS", "Crear una página web responsiva usando HTML5 semántico y CSS3 con Flexbox.", 100, 15.00, "2025-03-10 08:00:00", "2025-03-12 23:59:59");
    

-- Calificaciones
call sp_agregarCalificacion(1, 1, 85.00, "Buen dominio de ciclos y funciones, debe mejorar en arreglos.", "Revisar el tema de arreglos bidimensionales para el siguiente parcial.", 1);
    
call sp_agregarCalificacion(3, 1, 90.00, "Excelente dominio del modelo ER y normalización.", "Continúa así, los temas avanzados de SQL requieren esta base sólida.", 1);
    
call sp_agregarCalificacion(4, 2, 72.00, "Puede mejorar, el CSS responsivo presentó errores en móvil.", "Practicar más media queries y el uso de Flexbox con contenedores anidados.", 2);

-- Postulaciones
call sp_agregarPostulacion(1, 1, "Estoy cursando 4to semestre de Ingeniería en Sistemas con promedio de 85. He desarrollado proyectos personales en Node.js y Angular que refuerzan mi interés en esta pasantía.","cv_carlos_mendoza.pdf", 88.50);

call sp_agregarPostulacion(2, 2, "Mi promedio actual es 88 puntos y no tengo materias reprobadas. Considero que esta beca me permitirá enfocarme completamente en mis estudios.", "cv_andrea_lopez.pdf", 92.00);
    
call sp_agregarPostulacion(3, 1, "Tengo experiencia previa en desarrollo web y actualmente curso el 5to semestre. Me interesa aplicar mis conocimientos en un entorno profesional real.", "cv_maria_garcia.pdf", 80.00);
    
call sp_agregarPostulacion(1, 3, "Busco un empleo de medio tiempo que me permita sostener mis estudios. Tengo disponibilidad los fines de semana y buenas habilidades de comunicación.", "cv_carlos_v2.pdf", 75.00);

-- Solicitudes de Ajuste
-- Va dirigida a un profesor (empleador en null)
call sp_agregarSolicitud(1, "CAMBIO_HORARIO", "Solicito cambio de horario de la clase del lunes de 07:00 a 09:00 por traslape con mi horario de trabajo.", "Trabajo en Tech Solutions de lunes a viernes de 07:00 a 13:00 y el horario actual me genera conflicto.", 1, null);

-- Va dirigida a un empleador (profesor en null)
call sp_agregarSolicitud(2, "PERMISO_LABORAL", "Solicito permiso para ausentarme del trabajo el martes 18 de marzo de 14:00 a 16:00 por examen parcial.", "El examen de Base de Datos es obligatorio y tiene fecha fija establecida por la universidad.", null, 2);
